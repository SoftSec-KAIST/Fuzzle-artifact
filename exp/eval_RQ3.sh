...
# equality
OUT_EQ=$OUT_PATH/outputs/test_equality
python3 ./run_tools.py $CONFIG_DIR/test_equality.conf $OUT_EQ
./save_results.sh $OUT_EQ $OUT_EQ/equality_results $PARAM $DURATION $MODE > $OUT_EQ/equality_summary

# real-constraints
OUT_NEG=$OUT_PATH/outputs/test_constr
python3 ./run_tools.py $CONFIG_DIR/test_neg.conf $OUT_NEG

...
# binutils v2.26
OUT_BIN=$OUT_PATH/outputs_short/test_binutils
python3 ./run_tools_binutils.py $CONFIG_DIR/test_binutils_p.conf $OUT_BIN
...
PARAM="Generator"
OUT_FUZZLE=$OUT_PATH/outputs_short/test_fuzzle
python3 ./run_tools.py $CONFIG_DIR/test_fuzzle_p.conf $OUT_FUZZLE
